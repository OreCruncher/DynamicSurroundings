### DynamicSurroundings-1.10.2-3.4.9.17
**Fixes**
...
### DynamicSurroundings-1.10.2-3.4.9.16
**Fixes**
* Backport: Crash on dedicated server due to Forge annotation processing.

### DynamicSurroundings-1.10.2-3.4.9.15
**Fixes**
...
### DynamicSurroundings-1.10.2-3.4.9.12
**Changes**
...
### DynamicSurroundings-1.10.2-3.4.9.6
**Fixes**
...
### DynamicSurroundings-1.10.2-3.4.9.5
**What's New**
...
### DynamicSurroundings-1.10.2-3.4.9.4
**What's New**
...
* The ItemRegistry was redone.  Let me know if you run into problems with item sounds and the like.
...
### DynamicSurroundings-1.10.2-3.4.9.3
**What's New**
...
### DynamicSurroundings-1.10.2-3.4.9.2
**What's New**
...
* Reworked the internal effect handling to move most of it 100% client side (craft sound requires server for sound routing):
    * Footstep sounds and prints - These effects will play for other players without requiring server support.  As a bonus, Villagers, Witches, and Zombies leave footprints and have the same footstep sounds.
...
### DynamicSurroundings-1.10.2-3.4.8.3
**Fixes**
...
### DynamicSurroundings-1.10.2-3.4.8.2
**Fixes**
...
* Fix for java.lang.AbstractMethodError: Method net/minecraftforge/fml/common/registry/FMLControlledNamespacedRegistry.getKeys()Ljava/util/Set; is abstract
...
### DynamicSurroundings-1.10.2-3.4.8.1
**Fixes**
...
### DynamicSurroundings-1.10.2-3.4.7.0
**What's New**
...
* Mod profile updates for "out of the box" support:
    ...
    * Refreshed Minecraft, Biomes O'Plenty, Tinker's Construct, Harvestcraft, Natura, Tough as Nails, Subtratum, Actually Additions
...
### DynamicSurroundings-1.10.2-3.4.5.5
**What's New**
...
### DynamicSurroundings-1.10.2-3.4.5.4
**Fixes**
...
* Changes for Weather2 compatibility.
    * If Weather2 is installed Dynamic Surroundings will default to Vanilla handling of rain/thunder timers and intensity.
    * Dynamic Surroundings will register it's weather renderer with the world provider and will render weather if permitted to do so.
    * Dynamic Surroundings will use ASM to hook rain splash processing and will render rain splash effects if permitted to do so.
    * Background ambient thunder will attempt to play/display if the world data indicates it is thundering and the current rain intensity exceeds the configured threshold (default 0.75).
    * Suggested Weather2 config changes:
        * On Weather2's Compatibility page, set "Storms when" to "Global Overcast"
        * Advanced settings, Page 9, set "Particle_RenderRainSnow" to "false"
