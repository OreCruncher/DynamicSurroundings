...
public class UtilityGL11Debug {
	public class GLproperty {
		...
		public String getLogText() {
			...
			if ("glIsEnabled()".equals(this.fetchCommand)) {
				...
				builder.append(this.fetchCommand);
			}
	...
	public GLproperty[] propertyList = {
			...
			new GLproperty(GL11.GL_COLOR_INDEXES, "GL_COLOR_INDEXES", "ca, cd, and cs for color-index lighting",
					"lighting/enable", "glGetMaterialfv()"),
	...
	public static void dumpOpenGLstate(final ModLog log) {
		for (int i = 0; i < instance.propertyList.length; ++i) {
			if (instance.propertyList[i].canFetch())
				log.info(instance.propertyList[i].getLogText());
		}
	}

	public static void dumpAllIsEnabled(final ModLog log) {
		for (int i = 0; i < instance.propertyList.length; ++i) {
	...
	public static void dumpAllType(final ModLog log, final String type) {
		for (int i = 0; i < instance.propertyList.length; ++i) {
