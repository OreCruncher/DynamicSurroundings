package org.orecruncher.presets;
...
import org.orecruncher.presets.proxy.Proxy;
...
@net.minecraftforge.fml.common.Mod(modid = Presets.MOD_ID, useMetadata = true, dependencies = Presets.DEPENDENCIES, version = Presets.VERSION, acceptedMinecraftVersions = ModBase.MINECRAFT_VERSIONS, guiFactory = Presets.GUI_FACTORY, updateJSON = Presets.UPDATE_URL, clientSideOnly = true)
public class Presets {
	...
	public static final String GUI_FACTORY = "org.orecruncher.presets.gui.ConfigGuiFactory";
	...
	@SidedProxy(clientSide = "org.orecruncher.presets.proxy.ProxyClient", serverSide = "org.orecruncher.presets.proxy.Proxy")
